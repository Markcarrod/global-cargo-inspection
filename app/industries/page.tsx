...
const industries = [
    {
        ...
        description: 'Scrap metal, paper, plastics, and electronic waste inspection services.',
        image: '/images/industry-recycling.png',
        icon: Recycle,
        color: 'bg-green-600',
    ...
    },
    {
        ...
        description: 'Fresh produce, processed foods, and packaging safety compliance.',
    ...
    {
        title: 'Metals, Minerals, Ores & Concentrates',
        description: 'Quality verification for raw materials and mining products.',
    ...
    {
        title: 'Agricultural Industry & Fertilizers',
        description: 'Grain, seeds, fertilizers, and agricultural equipment inspections.',
    ...
    },
    {
        ...
        description: 'Electronics, textiles, toys, and general merchandise quality control.',
        image: '/images/industry-consumer.png',
        icon: ShoppingBag,
        color: 'bg-blue-600',
        hover: 'hover:border-blue-600',
    },
    {
        title: 'Petroleum & Petrochemical Industry',
        description: 'Crude oil, fuel, and chemical product testing and inspection.',
        image: '/images/industry-oil.png',
        icon: Droplet,
        color: 'bg-gray-800',
    ...
    },
    {
        ...
        description: 'Structural steel, pipes, coils, and fabrication inspection.',
        image: '/images/industry-industrial-v2.png',
        icon: Anvil,
        color: 'bg-zinc-600',
